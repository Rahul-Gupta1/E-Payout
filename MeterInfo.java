...
public class MeterInfo extends JFrame implements ActionListener{
    ...
    public Boolean validateMETERINFO(){
        ...
        if(meter_number.equals("")) {
            
            JOptionPane.showMessageDialog(null, "Enter meter_number");
            return false;
        }     
        if(meter_location.equals("")) {
            
            JOptionPane.showMessageDialog(null, "Enter meter_location");
            return false;
        }     
        if(meter_type.equals("")) {
            
            JOptionPane.showMessageDialog(null, "Enter meter_type");
            return false;
        }     
        if(phase_code.equals("")) {
            
            JOptionPane.showMessageDialog(null, "phase_code");
            return false;
        }     
        
        if(bill_type.equals("")) {
            
            JOptionPane.showMessageDialog(null, "bill_type");
            return false;
        }     
