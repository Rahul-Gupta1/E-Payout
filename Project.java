...
public class Project extends JFrame implements ActionListener{
 ...
 String meter;
    Project(String meter, String person){
        ...
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("icon/background20.jpg"));
        Image i3 = ic.getImage().getScaledInstance(1920, 900,Image.SCALE_DEFAULT);
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("icon/customerdetail.png"));
        ...
        ImageIcon icon3 = new ImageIcon(ClassLoader.getSystemResource("icon/calculatebill.png"));
        ...
        m4.setFont(new Font("Tahoma",Font.PLAIN,12));
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("icon/calculatebill1.png"));
        ...
        /* ---- Pay Bill ---- */
        info1.setFont(new Font("Tahoma",Font.PLAIN,12));
        ImageIcon icon41 = new ImageIcon(ClassLoader.getSystemResource("icon/updateinfo1.png"));
        Image image41 = icon41.getImage().getScaledInstance(30, 30,Image.SCALE_DEFAULT);
        ...
        /* ---- Last Bill ----*/
        info2.setFont(new Font("Tahoma",Font.PLAIN,12));
        ImageIcon icon42 = new ImageIcon(ClassLoader.getSystemResource("icon/viewinfo.png"));
        Image image42 = icon42.getImage().getScaledInstance(30, 30,Image.SCALE_DEFAULT);
        ...
        /* ---- Pay Bill ---- */
        u1.setFont(new Font("Tahoma",Font.PLAIN,12));
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("icon/payment2.png"));
        ...
        /* ---- Last Bill ----*/
        u3.setFont(new Font("Tahoma",Font.PLAIN,12));
        ImageIcon icon6 = new ImageIcon(ClassLoader.getSystemResource("icon/generatebill.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("icon/calculatebill.png"));
        ...
        /* ---- Calender ---- */
        ut1.setFont(new Font("Tahoma",Font.PLAIN,12));
        ...
        /* ---- Calculator ---- */
        ut2.setFont(new Font("Tahoma",Font.PLAIN,12));
        ...
        /* ---- Web Browser ---- */
        ut3.setFont(new Font("Tahoma",Font.PLAIN,12));
        ...
        /* ---- Exit ---- */
        ex.setFont(new Font("Tahoma",Font.PLAIN,12));
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("icon/logout.png"));
        Image image11 = icon11.getImage().getScaledInstance(40, 40,Image.SCALE_DEFAULT);
