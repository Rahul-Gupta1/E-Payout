...
public class NewCustomer extends JFrame implements ActionListener{
    ...
    NewCustomer(){
        ...
        ImageIcon ic1 = new ImageIcon(ClassLoader.getSystemResource("icon/newcutomer2.png"));
    ...
    public Boolean validateNEWCUSTOMER(){
        ...
        if(meter.equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "Enter meter");
            return false;
        }     
        if(address.equals("")) {
